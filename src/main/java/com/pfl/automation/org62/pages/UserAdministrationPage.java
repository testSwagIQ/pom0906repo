...
public class UserAdministrationPage extends BasePage{
	...
	By admin_user_search_checkbox  = By.xpath("//td[@class='userlist-checkbox-cell col-1']/input");
	...
	By user_admin_label = By.xpath("//h3[.='User Administration']");
    ...
    public void verifyUserAdministration(WebDriver driver) throws Exception {
    	//Verify that user located on User Administrator Page
    	WebElement label = findElement(driver, user_admin_label);
    	Assert.assertEquals(label, label.getText().toLowerCase().replaceAll("[ ()0-9]", ""));
	...
	public void Search_UserAdministration(WebDriver driver, String text) throws Exception {
		switchToFrame(driver);
	...
	public void search_user_on_user_administration(WebDriver driver,String parameter) throws Exception{
		driver.switchTo().defaultContent();
		switchToFrame(driver);
	...
	public void open_user_detail_section(WebDriver driver) throws Exception {
		...
		clickElement(driver, admin_user_detail1);
	...
	public void click_on_ok_user_confirmation(WebDriver driver) throws Exception {
		switchToFrame(driver);
		WebElement ele = driver.findElement(By.xpath("//button[contains(text(),'Ok') or contains(text(),'Yes')]"));
		JavascriptExecutor executor = (JavascriptExecutor)driver;
	...
	public void verify_unauthorized_message_on_administrator_page_on_classic(WebDriver driver) throws Exception {
		switchToFrame(driver);
	...
	public void change_user_access_to_standard(WebDriver driver) throws Exception {
		switchToFrame(driver);
	...
	public void save_user_on_Store(WebDriver driver) throws Exception {
		switchToFrame(driver);
	...
	public void change_user_access_to_admin(WebDriver driver) throws Exception {
		switchToFrame(driver);
		WebElement element = driver.findElement(By.xpath("//div[@id ='accessLevel']"));
		JavascriptExecutor executor = (JavascriptExecutor)driver;
		executor.executeScript("arguments[0].click();", element);
